...
import CATEGORY_OPTIONS from "@/lib/categoryOption";
import PRICE_OPTIONS from "@/lib/priceOption";

type FilterType = {
  [key: string]: string[];
};

interface ApplyArrayFilterParams {
  type: string;
  value: string;
}
...
const FilterCourseMobile = () => {
  ...
  const applyArrayFilter = (
    { type, value }: ApplyArrayFilterParams,
    filter: FilterType,
